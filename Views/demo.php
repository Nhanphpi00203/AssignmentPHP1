	...
	$(document).ready(function() {
		...
		$('.product').each(function(i, el) {
			...
			$(el).find('.view_gallery').click(function() {
				...
				setTimeout(function() {
					$(el).find('.make3D').removeClass('flip-10').addClass('flip90').find('div.shadow').show()
				...
				setTimeout(function() {
					...
					setTimeout(function() {
						$(el).find('.make3D').removeClass('flip190').addClass('flip180').find('div.shadow')
						.hide();
						setTimeout(function() {
		...
		$('.add-cart-large').each(function(i, el) {
			$(el).click(function() {
				...
				setTimeout(function() {
					...
					var cartItem = "<div class='cart-item'><div class='img-wrap'><img src='" + img.src +
						"' alt='' /></div><span>" + productName +
