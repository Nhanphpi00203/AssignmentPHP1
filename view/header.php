...
<head>
	...
	<title>ASM1-YAME</title>
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"
		integrity="sha384-d6dSUk9HYkVe7MZ1q2i8d8yNLE7FgAZtZHKCpmJ92pGRJN21zZwmy0oVOxOMvjXk" crossorigin="anonymous">
	...
	<section id="header">
		...
		<div>
			<ul id="navbar">
				...
				<li><a href="index.php?pg=admin">Admin</a></li>
				<li><a href="#"></a></li>
				<li><a href="#"></a></li>
				<?php if (is_user_logged_in()): ?>
				...
				<li id="id_user">
					<div class="dropdown-content">
						<a href="index.php?pg=profile_user" class="header__navsub-item"><img
								src="./layout/img/people/<?=$user_profile['hinh']?>" alt="" width="24px">
							<?=$user_profile['hoten']?></a>
						<a href="index.php?pg=profile_user&act=user_updates" class="header__navsub-item"><i
								class="fas fa-users-cog"></i> Cài Đặt</a>
						<a href="index.php?pg=dangxuat" id="dangxuat" class="header__navsub-item"><i
								class="fas fa-sign-out-alt"></i> Đăng xuất</a>
					</div>
					<a id="user"><img src="./layout/img/people/<?=$user_profile['hinh']?>" alt="" width="36px" height="36px"
        ...
        ?>
				...
				<li id="id_user">
					<div class="dropdown-content">
						<a href="index.php?pg=dangky" id="login1" class="header__navsub-item"><i class="fas fa-user-plus"></i> Đăng
							ký</a>
						<a href="index.php?pg=dangnhap" id="login1" class="header__navsub-item"><i class="fas fa-sign-in-alt"></i>
							Đăng nhập</a>
					</div>
