				...
				<div class="col-xs-12">
					<div class="form-group">
						<textarea class="form-input" name="comment" required=""
							placeholder="<?php if(!is_user_logged_in()){echo 'Bạn cần đăng nhập để bình luận!';}else{echo 'Bình luận dưới tên '.$user_profile['hoten'].'';}?>"></textarea>
						<button name="send" type="submit" class="btn btn-primary"
							style="margin-bottom: 46px;padding:14px">Gửi</button>
					</div>
				</div>
			</div>
		</form>
